...
**SCFA concentrations do not meaningfully vary with diagnosis or treatment.** To quantify the associations between colorectal cancer, the microbiome, and SCFAs, we quantified the concentration of acetate, propionate, isobutyrate, and butyrate in feces of previously characterized individuals with normal colons (N=`r n_normal`) and those with colonic adenomas (N=`r n_adenoma`) or carcinomas (N=`r n_cancer`) [@Baxter2016]. The only SCFA that had a significantly different concentration across the diagnoses was isobutyrate (P=`r iso_p_cross$p.value`; Figure 1A). The median concentration of isobutyrate was `r iso_p_cross$normal` mmol/kg in people with normal colons and it was `r iso_p_cross$adenoma` and `r iso_p_cross$cancer` mmol/kg in people with colonic adenomas or carcinomas. The difference in isobutyrate concentration between people with adenomas and carcinomas was significantly different (P=`r iso_p_cross["cancer-adenoma"]`); however, the differences between people with normal colons and those with adenomas or carcinomas was not significant (P=`r iso_p_cross["normal-adenoma"]` and P=`r iso_p_cross["normal-cancer"]`). The median concentration of isobutyrate in people with normal colons (`r iso_p_cross$normal` mmol/kg) was between those with adenomas (`r iso_p_cross$adenoma` mmol/kg) and carcinomas (`r iso_p_cross$cancer` mmol/kg). Among the subjects with adenomas and carcinomas, a subset (N~adenoma~=`r n_follow_adenoma`, N~carcinoma~=`r n_follow_cancer`) were treated and sampled a year later [@Sze2017]. The only SCFA that changed following treatment was isobutyrate, which decreased by `r iso_p_follow$estimate` mmol/kg (P=`r iso_p_follow$p.value`; Figure 1B). For both the pre-treatment cross-sectional data and the pre/post treatment data, we pooled the SCFA concentrations on a per molecule of carbon basis and again failed to see any significant differences (P>`r pooled_test`). The low concentration of isobutyrate relative to the other SCFAs, inconsistent concentrations, and unexpected decrease in concentration with treatment makes it difficult to ascribe much biological relevance to this observation.
