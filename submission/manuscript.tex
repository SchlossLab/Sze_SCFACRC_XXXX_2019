...
protocol (28). The following changes to this protocol included the use
...
1 (28) and Figure 1 in this report).

\textbf{16s rRNA gene sequencing.} The workflow and processing have been
described previously (26, 29, 30). The major differences from these
...
97\% similarity used the OptClust algorithm (31).
...
(19). This was repeated on 100 differen 80/20 splits of the data to
...
the statistical language R (39). Generally, differences between the
