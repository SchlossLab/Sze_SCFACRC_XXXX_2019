...
occur {[}{]} and treating all tumors as equal may actually hide any
benefit that could be found in specific subsets of individuals. Similar
to the idea of specific immunotherapy for specific tumors {[}{]}, SCFAs
...
individuals with normal colons versus patients with carcinomas {[}{]}.
...
\emph{Porphyromonas}, \emph{Parvimonas}, \emph{Peptostreptococcus}
{[}{]}). The idea of niche exclusion is similar to how the community
...
described in detail previously (8, 9). In brief, this study used fecal
...
removal of a tumor with or without chemotherapy and radiation (8).
Diagnosis of tumor was made by colonoscopic examination and
histopathological review of biopsies obtained (8, 9). The University of
...
protocol (10). The following changes to this protocol included the use
...
1 (10) and Figure 1 in this report).

\textbf{16s rRNA gene sequencing.} The workflow and processing have been
described previously (8, 11, 12). The major differences from these
...
97\% similarity used the OptClust algorithm (13).

\textbf{Generating imputed metagenomes.} The use of PICRUSt version
1.1.2 with the recommended standard operating protocol (14) was used.
...
previously described method (15). Briefly, the sequences were quality
filtered and sequences aligning to the human genome were removed prior
to contig assembly with MEGAHIT (16). Open Reading Frames (ORFs) were
identified using Prodigal (17), counts generated using Diamond (18),
subsequent clustering into Operational Protein Families (OPFs) used
mmseq2 (19), and OPF alignment used the KEGG database (20).
...
genes were based on pathways from KEGG as well as previous research (20,
21) and a list can be found in the supplemental material {[}Table S1{]}.
...
(22). This was repeated on 100 differen 80/20 splits of the data to
...
the statistical language R (23). Generally, differences between the
...
correct for multiple comparisons (24). First, we assessed differences in
...
8. \textbf{Sze MA}, \textbf{Baxter NT}, \textbf{Ruffin MT},
...
10. \textbf{Venkataraman A}, \textbf{Sieber JR}, \textbf{Schmidt AW},
...
12. \textbf{Kozich JJ}, \textbf{Westcott SL}, \textbf{Baxter NT},
...
13. \textbf{Westcott SL}, \textbf{Schloss PD}. 2017. OptiClust, an
improved method for assigning amplicon-based sequence data to
operational taxonomic units. mSphere \textbf{2}:e00073--17.
doi:\href{https://doi.org/10.1128/mspheredirect.00073-17}{10.1128/mspheredirect.00073-17}.

\hypertarget{ref-Langille2013}{}
14. \textbf{Langille MGI}, \textbf{Zaneveld J}, \textbf{Caporaso JG},
...
15. \textbf{Hannigan GD}, \textbf{Duhaime MB}, \textbf{Ruffin MT},
...
16. \textbf{Li D}, \textbf{Liu C-M}, \textbf{Luo R}, \textbf{Sadakane
...
17. \textbf{Hyatt D}, \textbf{Chen G-L}, \textbf{LoCascio PF},
...
18. \textbf{Buchfink B}, \textbf{Xie C}, \textbf{Huson DH}. 2014. Fast
...
19. \textbf{Steinegger M}, \textbf{Söding J}. 2017. MMseqs2 enables
...
20. \textbf{Kanehisa M}, \textbf{Sato Y}, \textbf{Kawashima M},
...
21. \textbf{Baxter NT}, \textbf{Zackular JP}, \textbf{Chen GY},
...
23. \textbf{R Core Team}. 2017. R: A language and environment for
