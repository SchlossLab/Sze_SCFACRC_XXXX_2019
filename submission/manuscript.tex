...
cause of death within the US {[}{]}. The envrionment has been attributed
as an important risk factor for CRC {[}{]}. This has lead to the
investigation of how the microbiota may exacerbate or cause tumorigensis
{[}{]} and whether the bacterial community is altered {[}{]}. Multiple
...
decreased in patients with carcinoma tumors {[}{]}. Many of these taxa
actively produce short-chain fatty acids (SCFAs) from fiber that is part
of our general diet {[}{]}. The most extensively studied of these SCFAs
are acetate, butyrate, and propionate {[}{]}. Overall, CRC is a growing
...
results in CRC treatment {[}{]}. In particular, butyrate has been shown
to inhibit cancer cell growth in \emph{in vitro} systems {[}{]}.
...
tumor burden while increasing SCFA concentrations {[}{]}. Although these
model systems provide important preliminary evidence towards the ability
of SCFAs to reduce and treat tumors, the studies reporting benefit in
humans has been less convincing.
...
with normal colons {[}{]}. Although this would argue that increasing
...
to protect against tumor recurrence {[}{]}. These findings would argue
