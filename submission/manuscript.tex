...
individuals without colon tumors (Control), adenomas, and carcinomas
(C). The black lines indicate the median SCFA concentration. Acetate
(D), butyrate (E), and propionate (F) concentrations in fecal samples
before and after treatment for adenoma (yellow) and carcinoma (red). The
black dots and lines represent the median change in SCFA concentration.
