...
occur (22) and treating all tumors as equal may actually hide any
benefit that could be found in specific subsets of individuals. Similar
to the idea of specific immunotherapy for specific tumors (23), SCFAs
...
24). Protection could be via a different pathway and other metabolites
...
described in detail previously (25, 26). In brief, this study used fecal
...
removal of a tumor with or without chemotherapy and radiation (25).
Diagnosis of tumor was made by colonoscopic examination and
histopathological review of biopsies obtained (25, 26). The University
...
protocol (27). The following changes to this protocol included the use
...
1 (27) and Figure 1 in this report).

\textbf{16s rRNA gene sequencing.} The workflow and processing have been
described previously (25, 28, 29). The major differences from these
...
97\% similarity used the OptClust algorithm (30).
...
previously described method (31). Briefly, the sequences were quality
filtered and sequences aligning to the human genome were removed prior
to contig assembly with MEGAHIT (32). Open Reading Frames (ORFs) were
identified using Prodigal (33), counts generated using Diamond (34),
subsequent clustering into Operational Protein Families (OPFs) used
mmseq2 (35), and OPF alignment used the KEGG database (36).
...
genes were based on pathways from KEGG as well as previous research (36,
37) and a list can be found in the supplemental material {[}Table S1{]}.
...
\hypertarget{ref-normalization_sze2017}{}
25. \textbf{Sze MA}, \textbf{Baxter NT}, \textbf{Ruffin MT},
\textbf{Rogers MAM}, \textbf{Schloss PD}. 2017. Normalization of the
microbiota in patients after treatment for colonic lesions. Microbiome
\textbf{5}.
doi:\href{https://doi.org/10.1186/s40168-017-0366-3}{10.1186/s40168-017-0366-3}.
...
26. \textbf{Baxter NT}, \textbf{Ruffin MT}, \textbf{Rogers MAM},
\textbf{Schloss PD}. 2016. Microbiota-based model improves the
sensitivity of fecal immunochemical test for detecting colonic lesions.
Genome Medicine \textbf{8}.
doi:\href{https://doi.org/10.1186/s13073-016-0290-3}{10.1186/s13073-016-0290-3}.
...
27. \textbf{Venkataraman A}, \textbf{Sieber JR}, \textbf{Schmidt AW},
...
29. \textbf{Kozich JJ}, \textbf{Westcott SL}, \textbf{Baxter NT},
...
30. \textbf{Westcott SL}, \textbf{Schloss PD}. 2017. OptiClust, an
...
32. \textbf{Li D}, \textbf{Liu C-M}, \textbf{Luo R}, \textbf{Sadakane
...
33. \textbf{Hyatt D}, \textbf{Chen G-L}, \textbf{LoCascio PF},
...
34. \textbf{Buchfink B}, \textbf{Xie C}, \textbf{Huson DH}. 2014. Fast
...
35. \textbf{Steinegger M}, \textbf{Söding J}. 2017. MMseqs2 enables
...
36. \textbf{Kanehisa M}, \textbf{Sato Y}, \textbf{Kawashima M},
...
37. \textbf{Baxter NT}, \textbf{Zackular JP}, \textbf{Chen GY},
\textbf{Schloss PD}. 2014. Structure of the gut microbiome following
colonization with human feces determines colonic tumor burden.
Microbiome \textbf{2}:20.
doi:\href{https://doi.org/10.1186/2049-2618-2-20}{10.1186/2049-2618-2-20}.
