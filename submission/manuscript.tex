...
or carcinoma (P-value \textgreater{} 0.80) {[}Figure 1D - 1F{]}.
...
\textbf{The number of significant positive correlations between OTU
relative abundance and SCFA concentration are similar for individuals
without tumors and patients with adenoma or carcinoma tumors.} Having
found no difference in SCFA concentrations or genes coding for enzymes
...
the majority of OTU correlations were to taxa from \emph{Clostridiales},
\emph{Lachnospiraceae}, and \emph{Ruminococcaceae} {[}Figure 3 \& Table
S5{]}. A similar pattern was observed when using high/low SCFA groups
based on the overall median concentration for that specific SCFA
{[}Figure S1 \& Table S6{]}. There was a noticeablely higher number of
significant negative correlations associated with patients with adenoma
versus the other groups for all SCFAs tested {[}Figure 3{]}. In
particular, OTUs from the \emph{Ruminococcaceae} family seemed to have
the largest share of these negative correlations within patients with
adenoma tumors {[}Figure 3{]}. The number of positive correlations
between OTUs and SCFA concentrations was similar between individuals
without tumors and patients with a carcinoma {[}Figure 3{]}. Although
patients with adenomas had more positive correlations between OTUs and
SCFA concentrations, their total number was more similar to the other
groups than the number of negative correlations {[}Figure 3{]}. Overall,
these results suggest that the resident taxa that may change the most
due to carcinoma tumors may not be ones that are responsible for the
production of acetate, butyrate, or propionate.

\textbf{SCFA concentrations do not replace all important
...
built models with OTU abundance data only or OTU abundances and SCFA
...
versus OTUs only {[}Figure 4B-C \& 4E-F{]}. The reason for this seems to
be because SCFA concentrations replaced the information gained by
specific OTUs rather than add new information to the model {[}Figure
4B-C{]}. The SCFA concentrations also only replaced select OTUs with
taxonomic classification to \emph{Clostridiales},
\emph{Lachnospiraceae}, and \emph{Ruminococcaceae} with many OTUs within
these taxa remaining {[}Figure 4B \& 4C{]}. In combination with the
previous results on taxa correlations, these observations provide
additional evidence that the resident taxa within models that classify
tumor are not ones associated with acetate, butyrate, or propionate
production.

\textbf{Random Forest models for SCFA concentrations have different top
10 most important OTUs than disease models.} Using OTU data we built
Random Forest models to classify either SCFA concentration or higher
than median and lower than median SCFA concentrations. Overall, OTU data
had a reasonable ability to classify both SCFA concentrations and high
and low SCFA concentrations {[}Figure 5A \& S2A{]}. However, these
models tended to be over fit, suggesting that rarer taxa may be
important for this classification {[}{[}Figure 5A \& S2A{]}.
Additionally, there were differences classification for both models
based on whether the individual had no tumors, an adenoma, or a
carcinoma {[}Figure 5B \& S2B{]}. There was minimal overlap between
these model's most important OTUs and those used to classify patients
with either adenoma or carcinoma tumors {[}Figure 4B-C, 4E-F, 5C-E, and
S2C-E{]}. The only OTUs that did overlap between the models was OTU00167
(\emph{Clostridiales}) {[}Figure 4B-C, 4E-F, 5C-E, and S2C-E{]}.
OTU00167 was in the top 10 most important OTUs for the OTU adenoma model
and not in the SCFA and OTU adenoma model, however, acetate and butyrate
concentrations were {[}Figure 4B-C{]}. These observations provide
further evidence that it is possible to identify specific OTUs
...
and patients with an adenoma or carcinoma tumor.
