...
# write out the data
write_tsv(combined_data, "data/process/final_opf_shared.tsv")

#The normal file paths that are used and filter call
	# data/process/orf_gene_alignment.tsv
	# data/process/opf_shared.tsv
	# 0.5
