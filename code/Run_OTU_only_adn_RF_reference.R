...
test_data <- as.data.frame(read_csv("data/process/tables/adn_OTU_only_test_data.csv"))
eighty_twenty_splits <- as.data.frame(read_csv("data/process/tables/adn_OTU_only_eighty_twenty_splits.csv"))
...
save.image(paste("exploratory/adn_OTU_Only_RF_model_", i, ".RData", sep=""))