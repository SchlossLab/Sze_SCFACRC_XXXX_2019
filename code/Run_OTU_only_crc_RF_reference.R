### Build the best carcinoma model possible OTU only
### Running the model
## Marc Sze
...
test_data <- as.data.frame(read_csv("data/process/tables/crc_OTU_only_test_data.csv"))
eighty_twenty_splits <- as.data.frame(read_csv("data/process/tables/crc_OTU_only_eighty_twenty_splits.csv"))
...
save.image(paste("exploratory/crc_OTU_only_RF_model_", i, ".RData", sep=""))