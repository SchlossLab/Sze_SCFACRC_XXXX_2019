...
### Generate test and random 80/20 split data needed for OTU only carcinoma RF analysis
## Marc Sze
...
write.csv(test_data, "data/process/tables/crc_OTU_only_test_data.csv", row.names = F)
...
write.csv(eighty_twenty_splits, "data/process/tables/crc_OTU_only_eighty_twenty_splits.csv", row.names = F)
