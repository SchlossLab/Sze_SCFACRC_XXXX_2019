...
test_data <- as.data.frame(read_csv("data/process/tables/adn_full_test_data.csv"))
eighty_twenty_splits <- as.data.frame(read_csv("data/process/tables/adn_full_eighty_twenty_splits.csv"))
...
save.image(paste("exploratory/adn_full_RF_model_", i, ".RData", sep=""))